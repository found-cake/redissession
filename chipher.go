...
func (c *Crypto) EncryptAndSign(data interface{}) (string, error) {
	...
	ciphertext := c.aead.Seal(nonce, nonce, jsonData, nil)
...
func (c *Crypto) DecryptAndVerify(encryptedData string, dest interface{}) error {
